#!/usr/bin/env bash
#
# Run the original DrEureka globe_walking Go2 faithful training with the
# original four-term inline Eureka reward.
...
CONTAINER_NAME="go2-globe-faithful-train-$(date +%Y%m%d-%H%M%S)"
